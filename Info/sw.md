...
| Program                                 | URL / Notes                                                                                                                                                                                                                                                     |
| --------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **UCINET**                              | [https://www.analytictech.com/ucinet/](https://www.analytictech.com/ucinet/)                                                                                                                                                             |
| **Pajek**                               | [http://mrvar.fdv.uni-lj.si/pajek/](http://mrvar.fdv.uni-lj.si/pajek/)                                                                                                                                                                      |
| **Gephi**                               | [https://gephi.org/](https://gephi.org/)                                                                                                                                                                                                       |
| **NetMiner**                            | netminer <br>NetMiner Viewer download: [https://netminer-viewer.software.informer.com/](https://netminer-viewer.software.informer.com/)  |
| **Cytoscape**                           | [https://cytoscape.org/](https://cytoscape.org/)                                                                                                                                                                                           |
| **NodeXL**                              | NodeXL site / gallery: [http://nodexlgraphgallery.org/](http://nodexlgraphgallery.org/)                                                                                                                                                       |
...
| **SocNetV (Social Network Visualizer)** | [https://github.com/socnetv/app](https://github.com/socnetv/app)                                                                                                                                                                |
...
| Nets (Python “Nets” visualization) | [https://github.com/PythonnotJava/Nets](https://github.com/PythonnotJava/Nets)                                                                                            |
...
| RSiena                             | CRAN page: [https://cran.rstudio.com/web/packages/RSiena/index.html](https://cran.rstudio.com/web/packages/RSiena/index.html)  <br>Official site / documentation: [https://www.stats.ox.ac.uk/~snijders/siena/](https://www.stats.ox.ac.uk/~snijders/siena/)  <br>GitHub repository: [https://github.com/stocnet/rsiena](https://github.com/stocnet/rsiena)                                   |
| tnet                               | [https://cran.r-project.org/web/packages/tnet](https://cran.r-project.org/web/packages/tnet)                                                                                             |
| multiplex                          | CRAN page: [https://cran.r-project.org/web/packages/multiplex/index.html](https://cran.r-project.org/web/packages/multiplex/index.html)  <br>GitHub / source issues: [https://github.com/mplex/multiplex](https://github.com/mplex/multiplex) (as per CRAN page)                                                                                                 |
| NetSim                             | R‑Forge / CRAN mirror: For example, at RDrr / rforge: [https://rdrr.io/rforge/NetSim/](https://rdrr.io/rforge/NetSim/)  <br>GitHub mirror: [https://github.com/cran/NetSim](https://github.com/cran/NetSim) (read‑only mirror)  <br>Original author site: (from documentation) “[http://www.christoph-stadtfeld.com/netsim”](http://www.christoph-stadtfeld.com/netsim”)  |
| influenceR                         | CRAN page: [https://search.r-project.org/CRAN/refmans/influenceR/html/influenceR.html](https://search.r-project.org/CRAN/refmans/influenceR/html/influenceR.html)  <br>GitHub: [https://github.com/khanna-lab/influenceR](https://github.com/khanna-lab/influenceR) (homepage listed in CRAN)                                                                                                  |
...
| netUtils                           | CRAN page: [https://cran.r-project.org/web/packages/netUtils/](https://cran.r-project.org/web/packages/netUtils/) <br>GitHub: [https://github.com/schochastics/netUtils/](https://github.com/schochastics/netUtils/)                                                                                                                                 |
...
| Erdos (Julia)                      | [https://www.juliapackages.com/p/erdos](https://www.juliapackages.com/p/erdos)                                                                                      |
| MultilayerGraphs                   | *No reliable canonical site found under exactly this name*                                                                                                                               |
| GraphDataFrameBridge (Julia)       | Julia package page: [https://juliapackages.com/p/graphdataframebridge](https://juliapackages.com/p/graphdataframebridge)                                               |
...
| EcologicalNetworks (Julia)         | Julia package registry listing: [https://juliapackages.com/p/ecologicalnetworks](https://juliapackages.com/p/ecologicalnetworks)                                       |
| CommunityDetection (Julia)         | GitHub: [https://github.com/afternone/CommunityDetection.jl](https://github.com/afternone/CommunityDetection.jl)                                                          |
| GraphPlot (Julia)                  | [https://github.com/JuliaGraphs/GraphPlot.jl](https://github.com/JuliaGraphs/GraphPlot.jl)                                                                                               |
| NetworkLayout (Julia)              | [https://github.com/JuliaGraphs/NetworkLayout.jl](https://github.com/JuliaGraphs/NetworkLayout.jl)                                |
...
| **CommunityDetection (other ecosystems)**               | There is also a Python package “community-detection” (PyPI) for community detection: [https://pypi.org/project/community-detection/](https://pypi.org/project/community-detection/)                              |
| **DynComm (dynamic community detection, R)**            | Listed on RDocumentation: [https://www.rdocumentation.org/packages/DynComm/versions/2020.1.6](https://www.rdocumentation.org/packages/DynComm/versions/2020.1.6)                                       |
| **EMLN / ecological multilayer networks (R / ecology)** | GitHub repository: [https://github.com/Ecological-Complexity-Lab/emln](https://github.com/Ecological-Complexity-Lab/emln) (for R package handling ecological multilayer networks)  |
